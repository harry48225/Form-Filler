...
import com.harry.formfiller.gui.question.QuestionPanelList;
...
public class QuestionList
{
	...
	public void writeDatabase()
	{
		...
		try (FileWriter fw = new FileWriter(databaseFileName)) // Declare a new file writer
		{
	...
	private void loadTypes()
	{
		...
		types = new String[0];
		try(BufferedReader br = new BufferedReader(new FileReader(typesFileName))) // Open the database file name
		{
	...
	public void writeTypes()
	{
		...
		try(FileWriter fw = new FileWriter(typesFileName))// Declare a new file writer
		{
